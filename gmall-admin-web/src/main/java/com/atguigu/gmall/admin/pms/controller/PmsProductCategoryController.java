...
public class PmsProductCategoryController {
    ...
    public Object getList(@PathVariable Long parentId,
        ...
        //TODO 分页查询商品分类
        Map<String,Object> pageInfo =  productCategoryService.pageProductCategory(pageSize,pageNum);
    ...
    public Object getItem(@PathVariable Long id) {
        //TODO 根据id获取商品分类
        Product product = productCategoryService.getProductById(id);
    ...
    public Object delete(@PathVariable Long id) {
        //TODO 删除商品分类
        /*boolean result = productCategoryService.removeProductById(id);
        if (result){
